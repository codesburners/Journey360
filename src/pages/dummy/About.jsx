...
const AboutContent = () => (
    <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
            <div>
                <h1 className="text-5xl font-extrabold text-gray-900 dark:text-white mb-6 tracking-tight leading-tight transition-colors">
                ...
                <div className="flex flex-wrap gap-4">
                    <div className="flex items-center gap-2 bg-emerald-50 dark:bg-emerald-900/20 px-4 py-2 rounded-full text-emerald-700 dark:text-emerald-400 font-semibold text-sm transition-colors">
                        <Globe size={18} />
                        <span>Global Coverage</span>
                    </div>
                    <div className="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 px-4 py-2 rounded-full text-slate-700 dark:text-slate-400 font-semibold text-sm transition-colors">
                        <Shield size={18} />
            ...
            <div className="relative">
                <img
                    ...
                    alt="Adventure"
                    className="rounded-3xl shadow-2xl shadow-emerald-200/50 dark:shadow-emerald-900/20 object-cover h-[400px] w-full"
                />
                <div className="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 hidden md:block transition-colors">
                    <div className="flex items-center gap-3">
                        <div className="p-3 bg-emerald-600 rounded-xl text-white">
                            <Users size={24} />
                        </div>
                        <div>
                            <p className="text-2xl font-bold text-gray-900 dark:text-white transition-colors">10k+</p>
                            <p className="text-xs text-gray-500 dark:text-gray-400 font-medium transition-colors">Active Travelers</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section className="mb-24">
            <div className="flex justify-between items-end mb-10">
                <div>
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2 transition-colors">Travel Insights</h2>
                    <p className="text-gray-500 dark:text-gray-400 transition-colors">Expert tips and stories from the Journey360 community.</p>
                </div>
                ...
                {[
                    ...
                    <article key={idx} className="group cursor-pointer">
                        <div className="relative overflow-hidden rounded-2xl mb-4 h-48">
                            ...
                            />
                            <div className="absolute top-4 left-4 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400 transition-colors">
                                {blog.category}
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 text-xs text-gray-400 dark:text-gray-500 font-medium transition-colors">
        ...
        {/* Mission Quote */}
        <section className="bg-slate-900 dark:bg-slate-900/50 rounded-[40px] p-12 lg:p-20 text-center relative overflow-hidden transition-colors">
